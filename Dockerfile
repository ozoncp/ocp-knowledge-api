...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-knowledge-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-knowledge-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-knowledge-api/bin/ocp-knowledge-api .
RUN chown root:root ocp-knowledge-api
EXPOSE 2021
CMD ["./ocp-knowledge-api"]